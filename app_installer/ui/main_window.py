...
class AppInstallerUI(ctk.CTk):
    def __init__(self):
        ...
        theme_path = Path(__file__).resolve().parent / "themes" / "neumorph.json"
    ...
    def create_widgets(self):
        ...
        NeumorphButton(button_frame, text="Instalar", command=self.install_selected).grid(row=0, column=0, padx=5, pady=5)
        NeumorphButton(button_frame, text="Configuraci\u00f3n", command=self.open_settings).grid(row=0, column=1, padx=5, pady=5)
